    ...
    (function(){
        this.setFilter = function(str) {
            ...
            matches = matches.filter(function(item){
                var caption = item.caption; //item.snippet || item.caption || item.value;
        ...
        this.filterCompletions = function(items, needle) {
            ...
            loop: for (var i = 0, item; item = items[i]; i++) {
                ...
                var caption = item.caption; //item.value || item.caption || item.snippet;
                if (!caption) continue;
                var lastIndex = -1;
                var matchMask = 0;
                var penalty = 0;
                var index, distance;
                // console.log("this.exactMatch =>",this.exactMatch)
